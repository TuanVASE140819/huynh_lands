  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        {/* Back to home button */}
        <Button asChild variant="ghost" className="mb-6 text-gray-600 hover:text-primary-600">
          <Link href="/">
        ...
        <Card className="shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-6">
            <div className="mx-auto mb-4 w-16 h-16 bg-gradient-to-r from-primary-500 to-accent-500 rounded-2xl flex items-center justify-center">
              <span className="text-white font-bold text-2xl">TA</span>
            </div>
            <CardTitle className="text-2xl font-bold bg-gradient-to-r from-primary-600 to-accent-600 bg-clip-text text-transparent">
              {text.title}
            </CardTitle>
            <CardDescription className="text-gray-600">{text.subtitle}</CardDescription>
          </CardHeader>

          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">{text.fullName}</label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-4 w-4" />
                  <Input
                    type="text"
                    placeholder="Nguyễn Văn A"
                    className="pl-10 border-2 border-gray-200 focus:border-primary-500 transition-colors"
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700">{text.userType}</label>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="••••••••"
                    className="pl-10 pr-10 border-2 border-gray-200 focus:border-primary-500 transition-colors"
            ...
            <div className="text-center">
              <span className="text-gray-600">{text.haveAccount} </span>
              <Link href="/dang-nhap" className="text-primary-600 hover:text-primary-700 font-medium hover:underline">
                {text.login}
              </Link>
            </div>
          </CardContent>
